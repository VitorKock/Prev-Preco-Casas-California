...
condados = sorted(gdf_geo['name'].unique()) #lista ordenada
...
with coluna2:
    view_state = pdk.ViewState(
        latitude=float(latitude[0]), # converter para float64 para compatibilidade da pydeck
        longitude=float(longitude[0]), # converter para float64 para compatibilidade da pydeck
        zoom=5,
        min_zoom=5,
        max_zoom=15,
    )
